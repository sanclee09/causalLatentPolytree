...
def get_star_polytree(n, seed, **kwargs):
...
extended_finite_sample_evaluation.get_random_polytree_via_pruefer = get_star_polytree


def main():
    """Run the exact same pipeline as extended_finite_sample_evaluation.py."""
    print("=" * 70)
    print("STAR TOPOLOGY FINITE-SAMPLE EVALUATION")
    print("=" * 70)
    ...
    # Star-specific output names
    extended_finite_sample_evaluation.plot_convergence_analysis(
        all_results,
        output_prefix="star_polytree_analysis"
    )
