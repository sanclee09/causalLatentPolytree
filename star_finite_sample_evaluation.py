...
def main():
    ...
    summary_df.to_csv("star_topology_results.csv", index=False)
    print(f"\n✅ Results saved to 'star_topology_results.csv'")
    print(f"✅ Combined plot saved to 'star_polytree_analysis.png'")
