...
\begin{itemize}
\item Single latent root configurations ($k=1$) in the finite-sample
experiments; the population-level experiments of Section~\ref{subsec:threshold_phenomenon}
used the maximal latent configuration (all eligible nodes hidden), but this
has not yet been studied under finite-sample conditions.
